...
func New(s *store.Store, logger logging.Logger, el eventlog.Writer, networkMgr *network.Manager, imageMgr *imagemanager.Manager, sshKeyMgr *sshkey.Manager) *Service {
	return &Service{
		store:       s,
		logger:      logger,
